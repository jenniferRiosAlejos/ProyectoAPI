...
agencias.each({ def agency ->
        ...
        if (agencyType == 'PLACE') {
            ...
            assert packageCapacity.isNumber() : 'El campo \'package_capacity\' debe ser un número para agencias de tipo \'PLACE\'.' // Si el tipo de agencia no es PLACE, asegurarse de que 'package_capacity' no esté presente
        } else {
